...
const socialMediaLinks = [
  ...
  {
    name: "Github",
    link: "https://github.com/manillama",
  ...
  {
    name: "Gmail",
    link: "mailto:t.ekmickey0118@gmail.com",
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Buildind data visualization website using Streamlit",
      ],
      softwareSkills: [
        {
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡ Containerization Deploying websites using Docker",
      ...
      softwareSkills: [
        ...
        {
          skillName: "MSSQL",
          fontAwesomeClassname: "devicon-plain:microsoftsqlserver",
          style: {
            color: "#47A248",
          },
        },
    ...
    },
    {
      ...
      skills: [
        "⚡ Experience of manipulation and analysis big data using utilizing libraris",
        "⚡ Cleaning for various deeplearning and statistical use cases",
        "⚡ Create data visualization tools usnig Streamlit",
      ],
      softwareSkills: [
        {
          skillName: "Python",
